    ...
    <div class="page-center">
        <div class="page-center-in">
            <div class="container-fluid">
                <form class="sign-box" action="{{route('login.store')}}" method="POST">
                    @csrf
                    ...
                    <p class="sign-note">Don't have an account? <a href="{{route('register')}}">Sign up</a></p>
